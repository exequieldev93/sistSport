...
<html>
  <head>
    ...
    <link rel="stylesheet" href="{{asset('boostrap4/css/bootstrap.min.css')}}">
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-lg"><b>SistSport</b></span>
        </a>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs">{{$nombre ?? Auth::user()->name}}</span>
                </a>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="{{url('acceso/rol')}}"><i class="fa fa-circle-o"></i> Rol</a></li>
              </ul>
            </li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="{{url('configuracion/tienda')}}"><i class="fa fa-circle-o"></i>Empresa</a></li>
     ...
     <!-- 
        ...
        <strong>Copyright &copy; 2020-2021 <a href="www.incanatoit.com">IncanatoIT</a>.</strong> All rights reserved.
      -->
